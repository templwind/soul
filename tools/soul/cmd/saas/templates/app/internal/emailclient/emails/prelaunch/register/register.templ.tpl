...
templ Body(props *email.Props) {
	...
	<p style="font-size: 18px; color: #264653;">Congratulations! You're moments away from unlocking a world of innovation. Your golden ticket is just a click away!</p>
