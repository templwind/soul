...
func defaultProps() *Props {
	return &Props{
		...
		HideOnMobile:      false,
		MaxContainerWidth: "max-w-screen-2xl",
	}
}
...
func WithBackLink(backLink ...soul.OptFunc[link.Props]) soul.OptFunc[Props] {
	return func(o *Props) {
		o.BackLink = link.WithProps(backLink...)
	}
}

func WithMaxContainerWidth(maxContainerWidth string) soul.OptFunc[Props] {
	return func(o *Props) {
		o.MaxContainerWidth = maxContainerWidth
	}
}

func WithTabProps(tabProps ...soul.OptFunc[tabs.Props]) soul.OptFunc[Props] {
	return func(o *Props) {
		o.TabProps = tabs.WithProps(tabProps...)
	}
}
