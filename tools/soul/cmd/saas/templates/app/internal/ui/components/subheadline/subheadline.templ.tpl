...
templ tpl(props *Props) {
	<h2 class="text-3xl tracking-tight font-display text-primary sm:text-4xl">
		if props.Text != "" {
			<span class="relative whitespace-nowrap">
				...
				<span class="relative">{ props.Start }</span>
			</span>
			{ props.End }
		} else {
			{ props.Text }
	...
	if props.Statement != "" {
		<p class="mx-auto mt-4 text-lg text-center text-accent sm:w-2/3">{ props.Statement }</p>
	}
}
