    ...
    <web-header>
        <header class="z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                if menu, ok := props.Menus["rail"]; ok {
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href={ templ.SafeURL(props.LoginURL) } class="text-sm font-semibold leading-6 text-gray-900">{ props.LoginTitle } <span aria-hidden="true">&rarr;</span></a>
                </div>
                }
            </nav>
